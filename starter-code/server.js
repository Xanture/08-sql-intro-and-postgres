...
app.get('/new', function(request, response) {
  ...
  /*
1 Number 5
2 This is the redirect from /new to /new.HTML.
3 This invokes the   articleView.initNewArticlePage(); in the new.html file
4 Readz with a z
  */
...
app.get('/articles', function(request, response) {
  ...
  /*
1 3 and 4 qurrey and reciving
2 This is fetching the data from our hackerIpsum. It's starts in index.html Article.fetchAll(articleView.initIndexPage);
3 This invokes Article.fetchAll(articleView.initIndexPage);
4 Read
*/
...
/*
1 3 and 4
2 This part they are filling out the form to create a new record. This will post the reccord to the database
3 No
4 new.html
*/
  client.query(
...
app.put('/articles/:id', function(request, response) {
  ...
  /*
  1 3
  2 Article.prototype.updateRecord and stuff
  3 updateRecord doesn't intereact with anything else
  4 Update
  */
  client.query(
    `UPDATE articles
...
// Put your response here... creates the table
loadDB();
...
function loadDB() {
  ...
  /*
1 3
2 this is loading the articles
3 negitive ghostrider the pattern is full-stack-diagram
4 Create
*/
  client.query(`
